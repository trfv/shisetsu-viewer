...
Cloudflare Workers にデプロイ済みのサーバーに接続します。

#### Claude Code で使う

https://app.shisetsudb.com のユーザーページで API トークンを発行し、以下のコマンドの `YOUR_API_TOKEN` 部分にコピーしたトークンを貼り付けて実行してください。
