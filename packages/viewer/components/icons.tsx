...
const Icon: FC<IconProps & { children: React.ReactNode }> = ({
  size = 24,
...
export const MenuIcon: FC<IconProps> = ({ "aria-label": ariaLabel, ...props }) => (
  <Icon aria-label={ariaLabel} {...props}>
    <path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" />
  </Icon>
);

export const ManageSearchIcon: FC<IconProps> = (props) => (
  <Icon {...props}>
    <path d="M7 9H2V7h5v2zm0 3H2v-2h5v2zm13.59 7l-3.83-3.83c-.8.52-1.74.83-2.76.83-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5c0 1.02-.31 1.96-.83 2.75L22 18.59 20.59 19zM17 11c0-1.65-1.35-3-3-3s-3 1.35-3 3 1.35 3 3 3 3-1.35 3-3zM2 15h5v-2H2v2z" />
  </Icon>
);
...
export const BrightnessAutoIcon: FC<IconProps> = (props) => (
  <Icon {...props}>
...
export const OpenInNewIcon: FC<IconProps> = (props) => (
  <Icon {...props}>
